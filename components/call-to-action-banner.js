...
export default function CallToActionBanner() {
  return (
    ...
    >
      ...
      <div className="px-4 md:px-0 w-full md:w-1/2 flex flex-col justify-center items-center md:absolute md:bottom-[8rem] md:left-[5rem]">
        ...
        <div className="flex flex-col justify-center items-center bg-gray-300 w-full px-4 py-5 lg:py-8 lg:px-12 mt-4 lg:mt-10">
          <p className="uppercase text-md text-center tracking-wide leading-relaxed text-white opacity-100">
