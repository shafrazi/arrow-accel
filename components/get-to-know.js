  ...
  return (
    <div className="relative">
      <div className="flex w-full relative">
        ...
        <div className="w-full lg:w-1/2 lg:mr-20 bg-gray-200 flex flex-col justify-center items-center text-base md:text-lg lg:text-xl tracking-wide py-6 md:py-[1rem] lg:py-[13rem] px-5 md:px-10 lg:px-[8rem]">
