      ...
      <div className="flex flex-col lg:flex-row w-full mt-6 lg:mt-16">
        <div className="flex flex-col w-full lg:w-1/2 justify-center items-center">
          <div className="w-full lg:w-10/12 py-6 md:py-10 lg:py-16 px-4 md:px-10 lg:px-0">
            ...
            <p className="tracking-wide text-lg md:text-2xl mt-5 lg:mt-10">
              We are commited to drive the energy transition past Net Zero
              targets to meet 1.5 ºC sustainability goals of the Paris
              Agreement. The transition needs to be accelerated as we are
              running our of time.
            </p>
            <p className="tracking-wide text-lg md:text-2xl mt-5 lg:mt-10">
              ...
              breakthrough solutions that contribute to protecting nature and
              life on Earth.
            </p>
          </div>
        </div>
        <div className="flex flex-col w-full lg:w-1/2 justify-center items-center bg-black text-white">
          <div className="w-full lg:w-10/12 py-6 md:py-10 lg:py-16 px-4 md:px-10 lg:px-0">
            ...
            <p className="tracking-wide text-lg md:text-2xl mt-5 lg:mt-10">
              ...
              and promote commercially viable new business, products and
              projects, using keen strategic and marketing insight and powerful
              design.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col-reverse lg:flex-row w-full mt-6 lg:mt-16">
        <div className="flex flex-col w-full lg:w-1/2 justify-center items-center bg-black text-white">
          <div className="w-full lg:w-10/12 py-6 md:py-10 lg:py-16 px-4 md:px-10 lg:px-0">
            ...
            <p className="tracking-wide text-lg md:text-2xl mt-10">
              We accelerate industrial innovation by bringing solutions to
              markets that solve transitional challenges in the energy market,
        ...
        <div className="flex flex-col w-full lg:w-1/2 justify-center items-center">
          <div className="w-full lg:w-10/12 py-6 md:py-10 lg:py-16 px-4 md:px-10 lg:px-0">
            ...
            <p className="tracking-wide text-lg md:text-2xl mt-10">
              The world around us is rapidly changing and a clear view of what
              the future holds, is diluted by every deeper avenue that
              technological advance takes us into. It can be hard to keep up,
              let alone to stay ahead. We are ahead of the tech curve.
            </p>
            <p className="tracking-wide text-lg md:text-2xl mt-10">
        ...
        <div className="flex flex-col w-full lg:w-1/2 justify-center items-center">
          <div className="w-full lg:w-10/12 py-6 md:py-10 lg:py-16 px-4 md:px-10 lg:px-0">
            ...
            <p className="tracking-wide text-lg md:text-2xl mt-10">
              ...
              capital sources for project of any size and strategy, growth
              equity, funds and philantropy for sustainable investment
              solutions.
            </p>
            <p className="tracking-wide text-lg md:text-2xl mt-10">
        ...
        <div className="flex flex-col w-full lg:w-1/2 justify-center items-center bg-black text-white">
          <div className="w-full lg:w-10/12 py-6 md:py-10 lg:py-16 px-4 md:px-10 lg:px-0">
            ...
            <p className="tracking-wide text-lg md:text-2xl mt-10">
              ...
              and digital assets. Our AR/VR/Metaverse and blended experiences
        ...
        <div className="w-full flex items-center lg:w-1/2">
          <div className="w-full flex space-x-10 lg:w-10/12 py-6 md:py-10 lg:py-16 px-4 md:px-10 lg:px-0">
            ...
            <div className="flex flex-col w-7/12 justify-around">
              ...
              <button className="w-full md:w-4/6 text-base bg-white text-black uppercase rounded px-3 py-2">
                set a meeting
              </button>
            </div>
          </div>
